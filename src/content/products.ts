...
export const products: Product[] = [
  ...
  },
  {
    ...
    category: "safety",
    icon: "Shield",
    image: "/montgomery-place/images/products/glowsafe.png",
    fullPage: true,
    color: "#10B981",
  },
  {
    ...
    category: "mobility",
    icon: "Move",
    image: "/montgomery-place/images/products/reelair.png",
    fullPage: true,
    color: "#3B82F6",
  },
  {
    ...
    category: "comfort",
    icon: "Heart",
    image: "/montgomery-place/images/products/flexcannula.png",
    fullPage: true,
    color: "#EC4899",
  },
  {
  ...
  },
  {
    ...
    category: "wellness",
    icon: "Activity",
    image: "/montgomery-place/images/products/breatheactive.png",
    fullPage: false,
    color: "#F59E0B",
  },
  {
    ...
    category: "portable",
    icon: "Briefcase",
    image: "/montgomery-place/images/products/gooxi.png",
    fullPage: false,
    color: "#EF4444",
  },
  {
    ...
    category: "hub",
    icon: "Users",
    image: "/montgomery-place/images/products/caredock.png",
    fullPage: false,
    color: "#06B6D4",
  },
];
